...
Inductive eval : Context -> Exp -> Val -> Prop :=
  ...
  | EvPlus : forall Sigma e1 e2 v1 v2 v,
               ...
               Sigma |- e2 ::: v2 ->
               v = v1 + v2 ->
               Sigma |- (Ops e1 plus e2) ::: v
               
  | EvMult : forall Sigma e1 e2 v1 v2 v,
               Sigma |- e1 ::: v1 ->
               Sigma |- e2 ::: v2 ->
               v = v1 * v2 ->
               Sigma |- (Ops e1 mult e2) ::: v
...
Example e : [] |- (Ops (Ops (Number 2) mult (Number 3)) plus (Number 3)) ::: 9.
Proof. eapply EvPlus.
  - eapply EvMult.
    * apply EvNum.
    * apply EvNum.
...
Example e2 : [(1, 6)] |- (Let 2 (Ops (Number 2) plus (Number 2))
                                (Ops (Var 2)    mult (Var 2))) ::: 16.
Proof. eapply EvLet.
  - eapply EvPlus.
    * apply EvNum.
    * apply EvNum.
